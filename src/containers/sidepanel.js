                ...
                <div id="profile">
                    <div className="wrap">
                        ...
                        <div id="expanded">
                            ...
                            <input name="twitter" type="text" value="mikeross" id="twitter" />
                            <label htmlFor="twitter1"><i className="fa fa-twitter fa-fw" aria-hidden="true"></i></label>
                            <input name="twitter1" type="text" value="ross81"  id="twitter1"/>
                            <label htmlfor="twitter2"><i className="fa fa-instagram fa-fw" aria-hidden="true"></i></label>
